...
run("Does adalimumab interact with CD274 protein?",
    ["adalimumab"], ["cd274"], "INTERACTS_WITH", "yesno")

# ADVERSE_EFFECT: drug → disease
run("What adverse effect is associated with etanercept?",
    ["etanercept"], [], "ADVERSE_EFFECT", "factoid")

# INTERACTS_WITH: protein list (head is protein)
run("Which drugs interact with CTLA4 protein?",
    ["ctla4"], [], "INTERACTS_WITH", "list")
