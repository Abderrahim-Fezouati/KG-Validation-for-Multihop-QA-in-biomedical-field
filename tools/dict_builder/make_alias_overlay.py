...
def variants(canon_id):
    m = re.match(r'^(drug|disease|gene|protein|chemical|metabolite|pathway|anatomy|cell|organism|exon|intron|rna|dna|enzyme|receptor|antibody|antigen)_(.+)$', canon_id)
