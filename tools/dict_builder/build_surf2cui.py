...
Path(out_node2surfs).write_text(json.dumps(data, ensure_ascii=False, indent=2), encoding="utf-8")
...
Path(out_surf2cui).write_text(json.dumps(surf2cui, ensure_ascii=False, indent=2), encoding="utf-8")
